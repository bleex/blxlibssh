...
pub type ssh_kex_types_e = ::std::os::raw::c_uint;
...
pub type ssh_requests_e = ::std::os::raw::c_uint;
...
pub const ssh_channel_type_e_SSH_CHANNEL_AUTH_AGENT: ssh_channel_type_e = 5;
pub type ssh_channel_type_e = ::std::os::raw::c_uint;
...
pub type ssh_channel_requests_e = ::std::os::raw::c_uint;
...
pub const ssh_global_requests_e_SSH_GLOBAL_REQUEST_KEEPALIVE: ssh_global_requests_e = 3;
pub type ssh_global_requests_e = ::std::os::raw::c_uint;
...
pub type ssh_publickey_state_e = ::std::os::raw::c_int;
...
pub type ssh_server_known_e = ::std::os::raw::c_int;
...
pub type ssh_keycmp_e = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " @}"]
pub type ssh_options_e = ::std::os::raw::c_uint;
#[doc = " Code is going to write/create remote files"]
pub const SSH_SCP_WRITE: ::std::os::raw::c_uint = 0;
#[doc = " Code is going to read remote files"]
pub const SSH_SCP_READ: ::std::os::raw::c_uint = 1;
#[doc = " Code is going to read remote files"]
pub const SSH_SCP_RECURSIVE: ::std::os::raw::c_uint = 16;
...
pub type ssh_scp_request_types = ::std::os::raw::c_uint;
...
pub type ssh_connector_flags_e = ::std::os::raw::c_uint;
extern "C" {
...
pub type ssh_publickey_hash_type = ::std::os::raw::c_uint;
extern "C" {
